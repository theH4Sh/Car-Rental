...
const UserDropdown = ({ auth, mobile }) => {
    ...
    return (
        <div ref={dropdownRef} className={`relative ${mobile ? 'flex' : 'hidden md:flex'} items-center space-x-3 px-2 py-2 rounded-full transition duration-150 hover:bg-gray-200`}>
            <div 
            ...
            { open && (
                <div className="z-10 bg-white absolute right-0 mt-2 w-40 rounded-lg shadow-lg py-2 border border-gray-200 text-sm text-gray-600 pointer-events-none transition-all duration-300 ease-out opacity-100 scale-100">
                    {mobile && (
                    ...
                    <div className="border-b border-gray-200">
                        <Link className="flex justify-start items-center px-4 py-2 gap-2 hover:bg-gray-100"><span><ShieldCheck className="w-4 h-4" /></span> Admin</Link>
